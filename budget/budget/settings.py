...
MIDDLEWARE = [
    ...
    'budget.middleware.LoginRequiredMiddleware',
]
...
EMAIL_HOST_USER = os.environ['LOGIN_GMAIL']
...
CORS_ALLOWED_ORIGINS = ['http://127.0.0.1', 'http://127.0.0.1:3000', 'http://localhost:3000']
